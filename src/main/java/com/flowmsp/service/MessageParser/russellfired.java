...
/*
NEWOCC #20-626  RAMB - Ambulance
Address: Homestead - 1070 E Wichita Ave, Russell

Reporting Person: female, Phone: 785-445-8717
Detail: female not breathing, lips are blue
*/
public class russellfired implements MsgParser {
    private static final Logger log = LoggerFactory.getLogger(russellfired.class);
	...
	var p = Pattern.compile("(NEWOCC|NEWINC) #.* - (.*)");
