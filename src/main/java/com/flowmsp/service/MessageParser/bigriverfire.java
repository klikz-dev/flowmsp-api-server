...
Active911#:237630418
*/
public class bigriverfire implements MsgParser {
    private static final Logger log = LoggerFactory.getLogger(bigriverfire.class);
	...
	pm.Code = get_matching_line(lines, "DISPATCH:CALL:(.*)");
