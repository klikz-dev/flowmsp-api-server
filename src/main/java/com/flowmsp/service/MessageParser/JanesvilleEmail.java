...
public class JanesvilleEmail implements MsgParser {
    private static final Logger log = LoggerFactory.getLogger(JanesvilleEmail.class);
	...
	try {
	    String plainMsg = msg;
	    // 2:48:40 PM 6/10/2018
	    //--------------------------------------------------
	    //               INCIDENT DETAILS
	    //LOCATION:
	    //Location:	MILTON AV / I 90 EB
	    //Loc Name:
	    //Loc Descr:
	    //City:	JV
	    //Building:
	    ...
	    //INCIDENT:
	    //Inc #:	00004901
	    //Inc #:	JVFD18061000004901
	    //Priority:	1
	    //Inc Type:
	    //Descr:	ACCIDENT WITH INJURY
	    //Mod Circum:
	    //Created:	12:48:23 PM 6/10/2018
	    //Caller:
	    //Phone:
	    //--------------------------------------------------
	    ...
	    //--------------------------------------------------
	    //UNITS DISPATCHED:
	    //JVFD/E815,JVFD/E814,JVFD/AM845
	    //--------------------------------------------------
	    //PERSONNEL DISPATCHED:
	    //JVFD/E815,JVFD/E814,JVFD/AM845
	    //--------------------------------------------------
	    //COMMENTS:
	    //OCCURED ON RAMP...STATE NEEDS PD TO HANDLE ACCIDENTBLK CHEV SONIC AND RED TRUCK W/ TOPPER
	    //--------------------------------------------------
	    //PREMISE HAZARD:
	    //get only message
	    int idx = -1;
	    ...
	    // Nuclear Power Plant, want a slightly different LAT/LON
	    if (parsedMessage.Address.equals("35100 S RT 53"))
		parsedMessage.messageLatLon = new Point(new Position(-88.228862, 41.242450));
