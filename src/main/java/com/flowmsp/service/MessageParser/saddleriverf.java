...
public class saddleriverf implements MsgParser {
    private static final Logger log = LoggerFactory.getLogger(saddleriverf.class);
	...
	*/
	    ...
	    var sit = Pattern.compile("Type of Fire Response: (.+)");
		...
		if (m.matches()) {
		    parsedMessage.Address = m.group(1) + ", Saddle River, NJ";
