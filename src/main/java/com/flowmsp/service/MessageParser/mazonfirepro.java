...
*/
public class mazonfirepro implements MsgParser {
    private static final Logger log = LoggerFactory.getLogger(mazonfirepro.class);
    ...
    public ParsedMessage Process(Customer cust, String msg, MessageService msgService) {
        ...
        try {
            ...
            String[] lines = parsedMessage.text.split(";");
