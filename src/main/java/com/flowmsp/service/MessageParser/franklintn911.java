...
CAD #2021-029456:
47
66 BRIARWOOD WAY, ESTILL SPRINGS [416] (35.266222, -86.146027)
68 YOM B/Y C/Y HAS FALLEN AND CANT GET UP
 */

public class franklintn911 implements MsgParser {
    private static final Logger log = LoggerFactory.getLogger(franklintn911.class);
    ...
    public ParsedMessage Process(Customer cust, String msg, MessageService msgService) {
        ...
        try {
            ...
            parsedMessage.incidentID = get_incidentID(lines);

            log.info("Code: " + parsedMessage.Code);
            log.info("Address: " + parsedMessage.Address);
            log.info("IncidentId: " + parsedMessage.incidentID);
    ...
    private String get_incidentID(String[] lines) {
        var incidentId = "";
        ...
        for (var line : lines) {
            if (line.startsWith("CAD")) {
                ...
                incidentId = m.find() ? m.group(1).replaceAll(".:", "") : "";
            }
        }
